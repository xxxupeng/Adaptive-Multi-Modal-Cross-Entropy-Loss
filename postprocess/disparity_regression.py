...
# single-modal weighted average with robust dominant modal range
class unimodal_disparityregression_Dominant(nn.Module):
    def __init__(self, maxdisp):
        super(unimodal_disparityregression_Dominant, self).__init__()
        self.maxdisp = maxdisp
