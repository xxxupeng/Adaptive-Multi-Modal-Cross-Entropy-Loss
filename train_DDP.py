...
def train(model,optimizer,imgL,imgR,disp_L,args,gpu):
    ...
    regression = __disparity_regression__[args.postprocess](args.maxdisp)   # SL1 loss
    if args.model == 'GANet':
        regression = __disparity_regression__[args.postprocess](args.maxdisp+1)     # The search range of GANet is [0,192] which has a total of 193 disparity candidates
